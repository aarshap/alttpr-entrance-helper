...
export default () => {
    return (
        <footer>
            <a href="https://github.com/aarshap/alttpr-entrance-helper/tree/master" target="_blank">
            ...
            <span>
                An <a href="https://alttpr.com" target="_blank">ALTTPR</a> entrance randomizer tool by your friend <a href="https://twitch.tv/okayaaron" target="_blank">Aaron</a>
            </span>
        </footer>
    )
}
